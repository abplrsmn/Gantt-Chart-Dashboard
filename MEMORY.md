...
- Project Details UI rule: do not show a single project-level PIC in Project Description. PIC belongs to each individual phase and may differ by phase; Assigned By remains a separate assignment-source field, not a substitute for PIC.
