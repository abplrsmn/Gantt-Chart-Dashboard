...
- **GChat Integration** (`/api/gchat/*`):
  Listens to webhook interactions from Google Chat (Chat Apps), allowing managers to trigger updates, confirm phases, or schedule GCal meetings directly from work chat interfaces.
