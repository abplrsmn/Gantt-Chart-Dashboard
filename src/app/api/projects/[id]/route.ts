...
const FIELD_MAP: Record<string, FieldMap> = {
  ...
  design_approval_target:       { table: "project_phases", column: "design_approval_target",         phaseId: 2 },
  design_end:                   { table: "project_phases", column: "design_approval_date",           phaseId: 2 },
  design_duration_days:         { table: "project_phases", column: "design_duration_days",           phaseId: 2 },
